...
def upgrade() -> None:
    # ── placements ────────────────────────────────────────────────────────────
    if not _table_exists("placements"):
        op.create_table(
            "placements",
    ...
    # ── workflow_status ───────────────────────────────────────────────────────
    if not _table_exists("workflow_status"):
        op.create_table(
            "workflow_status",
            sa.Column("workflow_id", sa.Text(), primary_key=True),
            sa.Column("status", sa.Text(), nullable=False),
    ...
    if not _table_exists("placement_predictions"):
        op.create_table(
            "placement_predictions",
            sa.Column("id", sa.Integer(), primary_key=True, autoincrement=True),
            sa.Column("workflow_id", sa.Text(), nullable=False),
    ...
    # ── ml_inference_logs ─────────────────────────────────────────────────────
    if not _table_exists("ml_inference_logs"):
        op.create_table(
            "ml_inference_logs",
            sa.Column("id", sa.Integer(), primary_key=True, autoincrement=True),
    ...
    # ── active_placements ─────────────────────────────────────────────────────
    if not _table_exists("active_placements"):
        op.create_table(
            "active_placements",
            sa.Column("id", sa.Integer(), primary_key=True, autoincrement=True),
            sa.Column("workflow_id", sa.Text(), nullable=False),
    ...
    # ── placement_history ─────────────────────────────────────────────────────
    if not _table_exists("placement_history"):
        op.create_table(
            "placement_history",
            sa.Column("id", sa.Integer(), primary_key=True, autoincrement=True),
            sa.Column("child_id", sa.Text(), nullable=True),
    ...
    # ── check_ins ─────────────────────────────────────────────────────────────
    if not _table_exists("check_ins"):
        op.create_table(
            "check_ins",
            sa.Column("id", sa.Integer(), primary_key=True, autoincrement=True),
            sa.Column("child_id", sa.Text(), nullable=False),
    ...
    if not _table_exists("processed_events"):
        op.create_table(
            "processed_events",
